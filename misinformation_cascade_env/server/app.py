...
"""
FastAPI application for the Misinformation Cascade Env Environment.

This module creates an HTTP server that exposes the MisinformationCascadeEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m misinformation_cascade_env.server.app
    ...
    multiple workers:
        uvicorn misinformation_cascade_env.server.app:app --workers 4
    """
    import uvicorn
